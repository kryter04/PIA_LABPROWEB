...
-- Este script se ejecuta dentro de ratemyprofs_db
-- -----------------------------------------------------
...
CREATE INDEX IF NOT EXISTS idx_ProfUniv_UniversityID ON ProfessorUniversities(UniversityID);
...
CREATE INDEX IF NOT EXISTS idx_ProfSubj_SubjectID ON ProfessorSubjects(SubjectID);
...
CREATE INDEX IF NOT EXISTS idx_Reviews_ProfessorID ON Reviews(ProfessorID);
CREATE INDEX IF NOT EXISTS idx_Reviews_SubjectID ON Reviews(SubjectID);
CREATE INDEX IF NOT EXISTS idx_Reviews_StatusID ON Reviews(StatusID);
...
CREATE INDEX IF NOT EXISTS idx_ReviewVotes_UserID ON ReviewVotes(UserID);
CREATE INDEX IF NOT EXISTS idx_ReviewVotes_ReviewID ON ReviewVotes(ReviewID);
CREATE INDEX IF NOT EXISTS idx_ReviewVotes_VoteTypeID ON ReviewVotes(VoteTypeID);
...
ON CONFLICT (VoteName) DO NOTHING;
